    ...
    <div className="min-h-screen bg-navy flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-cream/60 mt-2">Start your placement preparation journey</p>
        </div>

        {/* Signup Form */}
        <div className="bg-navy-light rounded-xl border border-gold/20 p-8">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="text-xs text-cream/50 mt-1">Minimum 6 characters</p>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-navy-light text-cream/60">Or continue with</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full flex items-center justify-center gap-3 bg-navy border border-gold/20 text-cream font-medium py-3 px-6 rounded-lg hover:bg-navy/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
